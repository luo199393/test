...
/*!********************************************************************!*\
  !*** ./node_modules/@tarojs/plugin-framework-vue3/dist/runtime.js ***!
  \********************************************************************/
/*! exports provided: createVue3App, setGlobalDataPlugin, useAddToFavorites, useDidHide, useDidShow, useOptionMenuClick, usePageScroll, usePullDownRefresh, usePullIntercept, useReachBottom, useReady, useResize, useRouter, useShareAppMessage, useShareTimeline, useTabItemTap, useTitleClick */
/*! exports used: createVue3App */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return createVue3App; });
...
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/slicedToArray.js */ "./node_modules/@babel/runtime/helpers/esm/slicedToArray.js");
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js */ "./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js");
...
function createHook(lifecycle) {
  return function (fn) {
    var id = Object(vue__WEBPACK_IMPORTED_MODULE_4__[/* inject */ "l"])('id');
    var fnRef = Object(vue__WEBPACK_IMPORTED_MODULE_4__[/* ref */ "s"])(fn);
    Object(vue__WEBPACK_IMPORTED_MODULE_4__[/* onMounted */ "o"])(function () {
      var inst = Object(_tarojs_runtime__WEBPACK_IMPORTED_MODULE_3__["getPageInstance"])(id);

      if (inst === undefined) {
        inst = Object.create({
          $options: {}
        });
        Object(_tarojs_runtime__WEBPACK_IMPORTED_MODULE_3__["injectPageInstance"])(inst, id);
      }
      ...
      if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_5__[/* isUndefined */ "j"])(currentCallback)) {
        inst[lifecycle] = callback;
      } else if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_5__[/* isFunction */ "g"])(currentCallback)) {
        inst[lifecycle] = [inst[lifecycle], callback];
      } else if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_5__[/* isArray */ "f"])(currentCallback)) {
        inst[lifecycle] = [].concat(Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(currentCallback), [callback]);
      }
    });
  };
}

var useDidShow = createHook('onShow');
var useDidHide = createHook('onHide');
var useReady = createHook('onReady');
var usePullDownRefresh = createHook('onPullDownRefresh');
var useReachBottom = createHook('onReachBottom');
var usePageScroll = createHook('onPageScroll');
var useResize = createHook('onResize');
var useShareAppMessage = createHook('onShareAppMessage');
var useTabItemTap = createHook('onTabItemTap');
var useTitleClick = createHook('onTitleClick');
var useOptionMenuClick = createHook('onOptionMenuClick');
var usePullIntercept = createHook('onPullIntercept');
var useShareTimeline = createHook('onShareTimeline');
var useAddToFavorites = createHook('onAddToFavorites');

var useRouter = function useRouter() {
  // return dynamic ? Current.router : React.useMemo(() => Current.router, [])
  return _tarojs_runtime__WEBPACK_IMPORTED_MODULE_3__["Current"].router;
};
...
function createVue3Page(h, id) {
  return function (component) {
    ...
    if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_5__[/* isArray */ "f"])(component.mixins)) {
    ...
    var ProviderComponent = {
      setup: function setup() {
        Object(vue__WEBPACK_IMPORTED_MODULE_4__[/* provide */ "q"])('id', id);
      },
...
function createVue3App(app, h, config) {
  ...
  var pages = [];
  var appInstance;
  Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_5__[/* ensure */ "d"])(!(Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_5__[/* isFunction */ "g"])(app._component) && !isClassComponent(app._component)), '入口组件不支持使用函数式组件');
  setReconciler();
  ...
  var _hooks$getMiniLifecyc = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(hooks.getMiniLifecycleImpl().app, 3),
  ...
  var appConfig = Object.create({
  ...
  }, Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(_Object$create, ONLAUNCH, setDefaultDescriptor({
    value: function value(options) {
      ...
      if (false) {} // 把 App Class 上挂载的额外属性同步到全局 app 对象中
      ...
      Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_5__[/* isFunction */ "g"])(onLaunch) && onLaunch.call(appInstance, options);
    }
  })), Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(_Object$create, ONSHOW, setDefaultDescriptor({
    value: function value(options) {
      var _a;

      setRouterParams(options);
      var onShow = (_a = appInstance === null || appInstance === void 0 ? void 0 : appInstance.$options) === null || _a === void 0 ? void 0 : _a.onShow;
      Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_5__[/* isFunction */ "g"])(onShow) && onShow.call(appInstance, options);
    }
  })), Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(_Object$create, ONHIDE, setDefaultDescriptor({
    value: function value(options) {
      var _a;

      var onHide = (_a = appInstance === null || appInstance === void 0 ? void 0 : appInstance.$options) === null || _a === void 0 ? void 0 : _a.onHide;
      Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_5__[/* isFunction */ "g"])(onHide) && onHide.call(appInstance, options);
    }
  })), _Object$create));
  _tarojs_runtime__WEBPACK_IMPORTED_MODULE_3__["Current"].app = appConfig;
  return appConfig;
}

function isClassComponent(value) {
  return Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_5__[/* isFunction */ "g"])(value) && '__vccOpts' in value;
}
...
function genAttrMapFnFromDir(dir) {
  var fn = function fn(key, value) {
    ...
    if (lowerKey in dir) {
      ...
      if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_2__[/* isString */ "i"])(res)) {
        key = res;
      } else {
        key = res[0];
...
function getMappedType(nodeName, rawProps) {
  if (inlineElements.has(nodeName)) {
    ...
    if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_2__[/* isString */ "i"])(mapping)) {
      return mapping;
    }

    var mapName = mapping.mapName;
    return Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_2__[/* isFunction */ "g"])(mapName) ? mapName(rawProps) : mapName;
  } else {
    return 'view';
  }
}
...
function getMapNameByCondition(nodeName, attr, props) {
  var mapping = specialElements.get(nodeName);
  if (!mapping || Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_2__[/* isString */ "i"])(mapping)) return;
  var mapName = mapping.mapName,
      mapNameCondition = mapping.mapNameCondition;
  if (!mapNameCondition) return;

  if (mapNameCondition.indexOf(attr) > -1 && !Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_2__[/* isString */ "i"])(mapName)) {
...
hooks.modifyHydrateData = function (data) {
  var nodeName = data["nn"
  /* NodeName */
  ];
  if (!isHtmlTags(nodeName)) return;
   true && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_2__[/* warn */ "q"])(data["nn"
  /* NodeName */
  ...
  if (attrMapFn) {
    for (var key in data) {
      ...
      var _attrMapFn = attrMapFn(key, value, data),
          _attrMapFn2 = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(_attrMapFn, 2),
  ...
  if (nodeName === 'br') {
    ...
    data["cn"
    /* Childnodes */
    ] = [(_ref = {}, Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(_ref, "nn"
    /* NodeName */
    , '#text'), Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(_ref, "v", '\n'), _ref)];
  }
...
hooks.modifySetAttrPayload = function (element, key, payload) {
  ...
  if (attrMapFn) {
    ...
    var _attrMapFn3 = attrMapFn(key, value, props),
        _attrMapFn4 = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(_attrMapFn3, 2),
...
hooks.modifyRmAttrPayload = function (element, key, payload) {
  var nodeName = element.nodeName,
      _path = element._path,
      props = element.props;
  if (!isHtmlTags(nodeName)) return; // map nodeName
  ...
  if (attrMapFn) {
    ...
    var _attrMapFn5 = attrMapFn(key, value, props),
        _attrMapFn6 = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(_attrMapFn5, 1),
...
hooks.onAddEvent = function (type, _handler, _options, node) {
  node = node;
...
hooks.modifyTaroEventImpls.push(function (event, element) {
  var nodeName = element.nodeName,
      props = element.props;
...
var needPromiseApis = new Set(['authPrivateMessage', 'disableAlertBeforeUnload', 'enableAlertBeforeUnload', 'getBackgroundFetchData', 'getGroupEnterInfo', 'getShareInfo', 'getWeRunData', 'join1v1Chat', 'openVideoEditor', 'saveFileToDisk', 'scanItem', 'setEnable1v1Chat', 'setWindowSize', 'sendBizRedPacket', 'startFacialRecognitionVerify', 'openCustomerServiceChat', 'getLocalIPAddress', 'getUserProfile', 'editImage']);

function initNativeApi(taro) {
  Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* processApis */ "n"])(taro, wx, {
...
Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* mergeReconciler */ "l"])(hostConfig);
Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* mergeInternalComponents */ "k"])(components);
...
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_set_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/set.js */ "./node_modules/@babel/runtime/helpers/esm/set.js");
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js */ "./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js");
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_get_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/get.js */ "./node_modules/@babel/runtime/helpers/esm/get.js");
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_getPrototypeOf_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/getPrototypeOf.js */ "./node_modules/@babel/runtime/helpers/esm/getPrototypeOf.js");
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_toArray_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/toArray.js */ "./node_modules/@babel/runtime/helpers/esm/toArray.js");
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_assertThisInitialized_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/assertThisInitialized.js */ "./node_modules/@babel/runtime/helpers/esm/assertThisInitialized.js");
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/inherits.js */ "./node_modules/@babel/runtime/helpers/esm/inherits.js");
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createSuper_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/createSuper.js */ "./node_modules/@babel/runtime/helpers/esm/createSuper.js");
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_wrapNativeSuper_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/wrapNativeSuper.js */ "./node_modules/@babel/runtime/helpers/esm/wrapNativeSuper.js");
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/defineProperty.js */ "./node_modules/@babel/runtime/helpers/esm/defineProperty.js");
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/classCallCheck.js */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/createClass.js */ "./node_modules/@babel/runtime/helpers/esm/createClass.js");
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_typeof_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/typeof.js */ "./node_modules/@babel/runtime/helpers/esm/typeof.js");
    ...
    (function (factory) {
      ...
      function makeExporter(target, previous) {
        return function (key, value) {
          if (!Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(target[key])) {
      ...
      var supportsSymbol = Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(Symbol);
      var toPrimitiveSymbol = supportsSymbol && !Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isUndefined */ "j"])(Symbol.toPrimitive) ? Symbol.toPrimitive : "@@toPrimitive";
      var iteratorSymbol = supportsSymbol && !Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isUndefined */ "j"])(Symbol.iterator) ? Symbol.iterator : "@@iterator";
      var supportsCreate = Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(Object.create); // feature test for Object.create support
      ...
      var _WeakMap = Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(WeakMap) ? WeakMap : CreateWeakMapPolyfill(); // [[Metadata]] internal slot
      ...
      function Type(x) {
        ...
        switch (Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_typeof_js__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(x)) {
          case "undefined":
            return 0
            /* Undefined */
            ;
      ...
      function IsSymbol(x) {
        return Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_typeof_js__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(x) === "symbol";
      } // 6.1.7 The Object Type
      // https://tc39.github.io/ecma262/#sec-object-type


      function IsObject(x) {
        return Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isObject */ "h"])(x) ? x !== null : Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(x);
      } // 7.1 Type Conversion
      ...
      function IsCallable(argument) {
        ...
        return Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(argument);
      ...
      function OrdinaryGetPrototypeOf(O) {
        ...
        if (!Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(O) || O === functionPrototype) return proto; // TypeScript doesn't set __proto__ in ES5, as it's non-standard.
        ...
        if (!Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(constructor)) return proto; // If we have some kind of self-reference, then we cannot determine the heritage.
      ...
      function CreateWeakMapPolyfill() {
        ...
        function GenRandomBytes(size) {
          if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(Uint8Array)) {
            if (!Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isUndefined */ "j"])(crypto)) return crypto.getRandomValues(new Uint8Array(size));
            if (!Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isUndefined */ "j"])(msCrypto)) return msCrypto.getRandomValues(new Uint8Array(size));
...
function __decorate(decorators, target, key, desc) {
  var c = arguments.length,
      ...
      d;
  if ((typeof Reflect === "undefined" ? "undefined" : Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_typeof_js__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(Reflect)) === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);else for (var i = decorators.length - 1; i >= 0; i--) {
...
function __metadata(metadataKey, metadataValue) {
  if ((typeof Reflect === "undefined" ? "undefined" : Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_typeof_js__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(Reflect)) === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(metadataKey, metadataValue);
}
...
var TaroEventTarget = /*#__PURE__*/function () {
  function TaroEventTarget() {
    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, TaroEventTarget);

    this.__handlers = {};
    this.hooks = getHooks();
  }

  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(TaroEventTarget, [{
    ...
    value: function addEventListener(type, handler, options) {
      ...
      if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isObject */ "h"])(options)) {
      ...
      if (isOnce) {
       ...
       true && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* warn */ "q"])(isCapture, 'Taro 暂未实现 event 的 capture 特性。'); // 某些框架，如 PReact 有委托的机制，handler 始终是同一个函数
    ...
    value: function removeEventListener(type, handler) {
      ...
      var index = handlers.findIndex(function (item) {
       ...
       true && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* warn */ "q"])(index === -1, "\u4E8B\u4EF6: '".concat(type, "' \u6CA1\u6709\u6CE8\u518C\u5728 DOM \u4E2D\uFF0C\u56E0\u6B64\u4E0D\u4F1A\u88AB\u79FB\u9664\u3002"));
...
function hydrate(node) {
  ...
  if (isText(node)) {
    ...
    return _ref = {}, Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(_ref, "v"
    /* Text */
    , node.nodeValue), Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(_ref, "nn"
    /* NodeName */
    , nodeName), _ref;
  }

  var data = (_data = {}, Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(_data, "nn"
  /* NodeName */
  , nodeName), Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(_data, "sid", node.sid), _data);
  ...
  for (var prop in props) {
    var propInCamelCase = Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* toCamelCase */ "o"])(prop);
...
var EventSource = /*#__PURE__*/function (_Map2) {
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])(EventSource, _Map2);

  var _super = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createSuper_js__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"])(EventSource);

  function EventSource() {
    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, EventSource);

    return _super.apply(this, arguments);
  }

  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(EventSource, [{
    key: "removeNode",
  ...
  return EventSource;
}( /*#__PURE__*/Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_wrapNativeSuper_js__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"])(Map));
...
var MutationObserverImpl = /*#__PURE__*/function () {
  function MutationObserverImpl(callback) {
    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, MutationObserverImpl);
  ...
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(MutationObserverImpl, [{
    key: "observe",
...
var MutationObserver = /*#__PURE__*/function () {
  function MutationObserver(callback) {
    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, MutationObserver);
  ...
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(MutationObserver, [{
    key: "observe",
...
var TaroNode = /*#__PURE__*/function (_TaroEventTarget) {
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])(TaroNode, _TaroEventTarget);

  var _super2 = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createSuper_js__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"])(TaroNode);

  function TaroNode() {
    var _this2;

    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, TaroNode);
    ...
    impl.bind(Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_assertThisInitialized_js__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(_this2));
    _this2.uid = "_n_".concat(nodeId()); // dom 节点 id，开发者可修改

    _this2.sid = _this2.uid; // dom 节点全局唯一 id，不可被修改

    eventSource.set(_this2.sid, Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_assertThisInitialized_js__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(_this2));
    return _this2;
  }
  /**
   * like jQuery's $.empty()
  ...
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(TaroNode, [{
    key: "_empty",
...
var TaroText = /*#__PURE__*/function (_TaroNode) {
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])(TaroText, _TaroNode);

  var _super3 = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createSuper_js__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"])(TaroText);

  function TaroText() {
    var _this5;

    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, TaroText);
  ...
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(TaroText, [{
    key: "textContent",
    get: function get() {
      return this._value;
    },
...
function setStyle(newVal, styleKey) {
  ...
  if (newVal) {
   ...
   true && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* warn */ "q"])(Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isString */ "i"])(newVal) && newVal.length > PROPERTY_THRESHOLD, "Style \u5C5E\u6027 ".concat(styleKey, " \u7684\u503C\u6570\u636E\u91CF\u8FC7\u5927\uFF0C\u53EF\u80FD\u4F1A\u5F71\u54CD\u6E32\u67D3\u6027\u80FD\uFF0C\u8003\u8651\u4F7F\u7528 CSS \u7C7B\u6216\u5176\u5B83\u65B9\u6848\u66FF\u4EE3\u3002"));
...
var Style = /*#__PURE__*/function () {
  function Style(element) {
    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, Style);
  ...
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(Style, [{
    key: "setCssVariables",
    ...
    get: function get() {
      ...
      this._usedStyleProp.forEach(function (key) {
        var val = _this7[key];
        if (!val) return;
        var styleName = isCssVariable(key) ? key : Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* toDashed */ "p"])(key);
    ...
    set: function set(str) {
      ...
      for (var i = 0; i < rules.length; i++) {
        ...
        var _rule$split = rule.split(':'),
            _rule$split2 = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_toArray_js__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])(_rule$split),
            propName = _rule$split2[0],
            valList = _rule$split2.slice(1);

        var val = valList.join(':');

        if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isUndefined */ "j"])(val)) {
          continue;
        }
    ...
    value: function setProperty(propertyName, value) {
      if (propertyName[0] === '-') {
        ...
        propertyName = Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* toCamelCase */ "o"])(propertyName);
      }

      if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isUndefined */ "j"])(value)) {
        return;
      }
...
var ClassList = /*#__PURE__*/function (_Set2) {
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])(ClassList, _Set2);

  var _super4 = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createSuper_js__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"])(ClassList);

  function ClassList(className, el) {
    var _thisSuper, _this9;

    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, ClassList);

    _this9 = _super4.call(this);
    className.trim().split(/\s+/).forEach(Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_get_js__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])((_thisSuper = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_assertThisInitialized_js__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(_this9), Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_getPrototypeOf_js__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(ClassList.prototype)), "add", _thisSuper).bind(Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_assertThisInitialized_js__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(_this9)));
    _this9.el = el;
    return _this9;
  }

  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(ClassList, [{
    key: "value",
    get: function get() {
      return Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(this).filter(function (v) {
        return v !== '';
      }).join(' ');
    }
  }, {
    ...
    value: function add(s) {
      Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_get_js__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_getPrototypeOf_js__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(ClassList.prototype), "add", this).call(this, s);
    ...
    value: function toggle(s) {
      if (Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_get_js__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_getPrototypeOf_js__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(ClassList.prototype), "has", this).call(this, s)) {
        Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_get_js__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_getPrototypeOf_js__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(ClassList.prototype), "delete", this).call(this, s);
      } else {
        Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_get_js__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_getPrototypeOf_js__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(ClassList.prototype), "add", this).call(this, s);
      }
    ...
    value: function contains(s) {
      return Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_get_js__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_getPrototypeOf_js__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(ClassList.prototype), "has", this).call(this, s);
    }
  }, {
    key: "toString",
  ...
  return ClassList;
}( /*#__PURE__*/Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_wrapNativeSuper_js__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"])(Set));

var TaroElement = /*#__PURE__*/function (_TaroNode2) {
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])(TaroElement, _TaroNode2);

  var _super5 = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createSuper_js__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"])(TaroElement);

  function TaroElement() {
    var _this10;

    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, TaroElement);
    ...
    impl.bind(Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_assertThisInitialized_js__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(_this10));
    _this10.nodeType = 1
    /* ELEMENT_NODE */
    ;
    _this10.style = new Style(Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_assertThisInitialized_js__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(_this10));
    (_b = (_a = _this10.hooks).patchElement) === null || _b === void 0 ? void 0 : _b.call(_a, Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_assertThisInitialized_js__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(_this10));
    return _this10;
  }

  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(TaroElement, [{
    ...
    set: function set(text) {
      Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_set_js__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_getPrototypeOf_js__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(TaroElement.prototype), "textContent", text, this, true);
    }
  }, {
    key: "hasAttribute",
    value: function hasAttribute(qualifiedName) {
      return !Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isUndefined */ "j"])(this.props[qualifiedName]);
    }
  }, {
    key: "hasAttributes",
    ...
    value: function setAttribute(qualifiedName, value) {
      var _a, _b;
       ...
       true && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* warn */ "q"])(Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isString */ "i"])(value) && value.length > PROPERTY_THRESHOLD, "\u5143\u7D20 ".concat(this.nodeName, " \u7684 \u5C5E\u6027 ").concat(qualifiedName, " \u7684\u503C\u6570\u636E\u91CF\u8FC7\u5927\uFF0C\u53EF\u80FD\u4F1A\u5F71\u54CD\u6E32\u67D3\u6027\u80FD\u3002\u8003\u8651\u964D\u4F4E\u56FE\u7247\u8F6C\u4E3A base64 \u7684\u9608\u503C\u6216\u5728 CSS \u4E2D\u4F7F\u7528 base64\u3002"));
      ...
      switch (qualifiedName) {
        ...
        default:
          ...
          if (qualifiedName.startsWith('data-')) {
            ...
            this.dataset[Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* toCamelCase */ "o"])(qualifiedName.replace(/^data-/, ''))] = value;
          }
      ...
      var payload = {
        path: "".concat(this._path, ".").concat(Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* toCamelCase */ "o"])(qualifiedName)),
        value: Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(value) ? function () {
          return value;
        } : value
      };
      ...
      if (this.nodeName === VIEW) {
        if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* toCamelCase */ "o"])(qualifiedName) === CATCHMOVE) {
...
var Performance = /*#__PURE__*/function () {
  function Performance() {
    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, Performance);

    this.recorder = new Map();
  }

  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(Performance, [{
    key: "start",
...
function findCustomWrapper(root, dataPathArr) {
  ...
  list.some(function (item, i) {
    ...
    if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isUndefined */ "j"])(currentData)) return true;
...
var TaroRootElement = /*#__PURE__*/function (_TaroElement) {
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])(TaroRootElement, _TaroElement);

  var _super6 = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createSuper_js__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"])(TaroRootElement);

  function TaroRootElement() {
    var _this12;

    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, TaroRootElement);
  ...
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(TaroRootElement, [{
    key: "_path",
    get: function get() {
      return ROOT_STR;
    }
    ...
    value: function performUpdate() {
      ...
      setTimeout(function () {
        ...
        var _loop2 = function _loop2(_path) {
          ...
          if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(value)) {
            data[_path] = value();
          }
        };
        ...
        if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(prerender)) return prerender(data); // 正常渲染
        ...
        if (initRender) {
          ...
          for (var p in data) {
            ...
            if (found) {
              ...
              customWrapperMap.set(customWrapper, Object.assign(Object.assign({}, customWrapperMap.get(customWrapper) || {}), Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])({}, "i.".concat(splitedPath), data[p])));
            } else {
              // 此项数据使用页面去更新
...
var FormElement = /*#__PURE__*/function (_TaroElement2) {
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])(FormElement, _TaroElement2);

  var _super7 = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createSuper_js__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"])(FormElement);

  function FormElement() {
    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, FormElement);

    return _super7.apply(this, arguments);
  }

  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(FormElement, [{
    key: "value",
    get: function get() {
      // eslint-disable-next-line dot-notation
...
var SVGElement = /*#__PURE__*/function (_TaroElement3) {
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])(SVGElement, _TaroElement3);

  var _super8 = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createSuper_js__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"])(SVGElement);

  function SVGElement() {
    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, SVGElement);

    return _super8.apply(this, arguments);
  }

  return Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(SVGElement);
...
var TaroEvent = /*#__PURE__*/function () {
  function TaroEvent(type, opts, event) {
    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, TaroEvent);
  ...
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(TaroEvent, [{
    key: "stopPropagation",
    ...
    get: function get() {
      ...
      if (!cacheCurrentTarget) {
        ...
        var element = _doc.getElementById(currentTarget.id);

        var targetElement = _doc.getElementById(((_c = (_b = this.mpEvent) === null || _b === void 0 ? void 0 : _b.target) === null || _c === void 0 ? void 0 : _c.id) || null);
...
function eventHandler(event) {
  ...
  if (node) {
    ...
    if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(hooks.batchedEventUpdates)) {
      var type = event.type;
...
var Scaner = /*#__PURE__*/function () {
  function Scaner(html) {
    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, Scaner);
  ...
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(Scaner, [{
    key: "scan",
    value: function scan() {
      var html = this.html,
...
var StyleTagParser = /*#__PURE__*/function () {
  function StyleTagParser() {
    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, StyleTagParser);

    this.styles = [];
  }

  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(StyleTagParser, [{
    key: "extractStyle",
      ...
      var selectors = list.map(function (item) {
        ...
        item = item.replace(/\[(.+?)\]/g, function (_, $1) {
          var _$1$split = $1.split('='),
              _$1$split2 = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(_$1$split, 2),
              key = _$1$split2[0],
              value = _$1$split2[1];
...
function format(children, document, styleOptions, parent) {
  return children.filter(function (child) {
    ...
    if (child.type === 'text') {
      ...
      if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(options.html.transformText)) {
    ...
    for (var i = 0; i < child.attributes.length; i++) {
      ...
      var _splitEqual = splitEqual(attr),
          _splitEqual2 = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(_splitEqual, 2),
          key = _splitEqual2[0],
    ...
    if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(options.html.transformElement)) {
...
function cloneNode(getDoc) {
  ...
  for (var key in this) {
    ...
    if ([PROPS, DATASET].includes(key) && Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_typeof_js__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(value) === OBJECT) {
...
var TaroNodeImpl = /*#__PURE__*/function () {
  ...
  getElement) {
    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, TaroNodeImpl);
  ...
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(TaroNodeImpl, [{
    key: "bind",
...
var TaroElementImpl = /*#__PURE__*/function () {
  function TaroElementImpl() {
    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, TaroElementImpl);
  }

  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(TaroElementImpl, [{
    key: "bind",
    value: function bind(ctx) {
      if (true) {
...
var TaroDocument = /*#__PURE__*/function (_TaroElement4) {
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])(TaroDocument, _TaroElement4);

  var _super9 = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createSuper_js__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"])(TaroDocument);

  function TaroDocument( // eslint-disable-next-line @typescript-eslint/indent
  getText) {
    var _this18;

    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, TaroDocument);
  ...
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(TaroDocument, [{
    key: "createElement",
    ...
    value: function getElementById(id) {
      ...
      return Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isUndefined */ "j"])(el) ? null : el;
    }
  }, {
    key: "querySelector",
...
var Hooks = /*#__PURE__*/function () {
  function Hooks() {
    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, Hooks);
  }

  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(Hooks, [{
...
if (true) {
  var globalProperties = [].concat(Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(Object.getOwnPropertyNames(global || win)), Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(Object.getOwnPropertySymbols(global || win)));
  ...
  window$1.addEventListener = _tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* noop */ "m"];
  window$1.removeEventListener = _tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* noop */ "m"];
...
var Events = /*#__PURE__*/function () {
  function Events(opts) {
    Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(this, Events);
  ...
  Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(Events, [{
    key: "on",
...
function safeExecute(path, lifecycle) {
  ...
  if (!Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isFunction */ "g"])(func)) {
    return;
  }
...
function createPageConfig(component, pageName, data, pageConfig) {
  ...
  var _hooks$getMiniLifecyc = Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(hooks.getMiniLifecycleImpl().page, 6),
  ...
  var loadResolver;
  var hasLoaded;
  var config = (_config = {}, Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(_config, ONLOAD, function () {
    var _this20 = this;
  ...
  }), Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(_config, ONUNLOAD, function () {
  ...
  }), Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(_config, ONREADY, function () {
    // 触发生命周期
  ...
  }), Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(_config, ONSHOW, function () {
    var _this21 = this;
  ...
  }), Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(_config, ONHIDE, function () {
    // 设置 Current 的 page 和 router
  ...
  if (!Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isUndefined */ "j"])(data)) {
    config.data = data;
  }
...
function createRecursiveComponentConfig(componentName) {
  ...
  var lifeCycles = isCustomWrapper ? {
    attached: function attached() {
      ...
      if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_14__[/* isString */ "i"])(componentId)) {
  ...
  return Object.assign({
    properties: {
      i: {
        type: Object,
        value: Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])({}, "nn"
        /* NodeName */
        , VIEW)
      },
      l: {
...
/*! exports used: EMPTY_OBJ, controlledComponent, defaultReconciler, ensure, internalComponents, isArray, isFunction, isObject, isString, isUndefined, mergeInternalComponents, mergeReconciler, noop, processApis, toCamelCase, toDashed, warn */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return mergeInternalComponents; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return mergeReconciler; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return processApis; });
...
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js */ "./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js");
/* harmony import */ var C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_typeof_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/typeof.js */ "./node_modules/@babel/runtime/helpers/esm/typeof.js");
...
function isObject(o) {
  return o !== null && Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_typeof_js__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(o) === 'object';
}
...
function processApis(taro, global) {
  ...
  var _needPromiseApis = new Set([].concat(Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(patchNeedPromiseApis), Object(C_namespaces_daima_hbulder_myApp2_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(needPromiseApis)));
